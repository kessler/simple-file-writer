...
SimpleFileWriter.prototype._flushBuffer = function (cb) {
...
SimpleFileWriter.prototype.end = function() {
	...
	if (this._paused) return; //dangerous?
...
SimpleFileWriter.prototype.endImmediately = function () {
	this._ending = true;
	this._log.end();
};
